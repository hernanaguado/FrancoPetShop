...
createApp({
    ...
    methods: {
      ...
      confirmarCompraAlerta(){
        let confirmarCompra = "¿Confirmar compra de " + (this.formatoPrecio.format(this.costoTotal() * 1.21)) + " ?" 
        ...
        swalWithBootstrapButtons.fire({
          ...
          if (result.isConfirmed) {
            swalWithBootstrapButtons.fire(
              '¡Aprobado!',
              "Felicidades, el producto es tuyo!",
              'success'
            )
          } else if (
